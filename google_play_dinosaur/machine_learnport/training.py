...
while img_num < ((int)(get_max_image)):
...
model.fit(x_train, y_train, batch_size=100, epochs=100, validation_data=(x_test, y_test), callbacks=[tbCallBack])

# save weights post training
model.save('fame_ai_weaits4s.h5')
